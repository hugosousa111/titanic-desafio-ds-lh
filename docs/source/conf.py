...
# titanic_desafio_ds documentation build
...
from titanic_desafio_ds import __version__ as release

# -- Project information -----------------------------------------------------

project = "titanic_desafio_ds"
author = "Kedro"
...
htmlhelp_basename = "titanic_desafio_dsdoc"
...
latex_documents = [
    (
        master_doc,
        "titanic_desafio_ds.tex",
        "titanic_desafio_ds Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "titanic_desafio_ds",
        "Project titanic_desafio_ds codebase.",
        "Data-Science",
    )
]
